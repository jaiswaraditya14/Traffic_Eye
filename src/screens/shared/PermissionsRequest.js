...
const styles = StyleSheet.create({
    ...
    title: { fontSize: 26, fontWeight: '800', color: C.navy, marginBottom: 12, letterSpacing: -0.5 },
    ...
    textCol: { flex: 1 },
    rowTitle: { fontSize: 16, fontWeight: '700', color: C.textPrimary, marginBottom: 2 },
    ...
    ghostBtnText: { fontSize: 15, fontWeight: '600', color: C.textSecondary },
});
