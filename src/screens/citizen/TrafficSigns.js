...
const styles = StyleSheet.create({
    ...
    speedValue: { fontSize: 18, fontFamily: 'Nunito-Bold', color: '#111827' },
    slashLine: { position: 'absolute', width: '120%', height: 3.5, backgroundColor: C.redAlert, transform: [{ rotate: '-45deg' }] },
    signTitle: { fontSize: 11, fontFamily: 'Nunito-Bold', color: C.textPrimary, textAlign: 'center', lineHeight: 14 },
});
