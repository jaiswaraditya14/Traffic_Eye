...
const styles = StyleSheet.create({
    ...
    sectionTitle: { fontSize: 13, fontWeight: '700', color: C.textSecondary, marginBottom: 8, marginLeft: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
    ...
    textCol: { flex: 1 },
    label: { fontSize: 16, fontWeight: '600', color: C.textPrimary, marginBottom: 2 },
    ...
    infoLabel: { fontSize: 15, fontWeight: '600', color: C.textPrimary },
    infoValue: { fontSize: 14, color: C.textSecondary, fontWeight: '500' },
    ...
    secureText: { fontSize: 12, fontWeight: '700', color: '#059669' },
