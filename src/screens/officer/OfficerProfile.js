...
const styles = StyleSheet.create({
    ...
    heroTitle: { fontSize: 18, fontWeight: '700', color: C.white },
    ...
    avatarInitials: { fontSize: 32, fontWeight: '800', color: C.navy, letterSpacing: 1 },
    ...
    heroName: { fontSize: 24, fontWeight: '800', color: C.white, marginBottom: 6, letterSpacing: -0.5 },
    ...
    heroBadge: { fontSize: 14, fontWeight: '600', color: C.white },
    ...
    statLabel: { fontSize: 12, fontWeight: '600', color: C.textTertiary, textTransform: 'uppercase' },

    // Menu
    sectionHeader: { fontSize: 14, fontWeight: '700', color: C.textSecondary, marginBottom: 8, marginLeft: 8, textTransform: 'uppercase', letterSpacing: 0.5 },
    ...
    menuItemText: { flex: 1, fontSize: 16, fontWeight: '600', color: C.textPrimary },

    footerVersion: { alignItems: 'center', marginTop: 10 },
    versionText: { fontSize: 12, color: C.textTertiary, fontWeight: '500', marginTop: 4 },
});
